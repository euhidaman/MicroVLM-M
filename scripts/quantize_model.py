...
def main():
    parser = argparse.ArgumentParser(description='Quantize MicroVLM-M to 1.58-bit BitNet')
    ...
    print(f"Size reduction: {fp16_size - quantized_size:.2f} MB ({100*(fp16_size - quantized_size)/fp16_size:.1f}%)")
