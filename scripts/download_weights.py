...
def download_deit_weights(output_dir, model_name="deit_tiny_patch16_224"):
    ...
    try:
        ...
        print(
            f"2. Run: python -c \"import timm; timm.create_model('{model_name}', pretrained=True)\"")
...
def main():
    ...
    parser.add_argument('--skip_bitnet', action='store_true',
                        help='Skip BitNet download')
    parser.add_argument('--skip_deit', action='store_true',
                        help='Skip DeiT download')
