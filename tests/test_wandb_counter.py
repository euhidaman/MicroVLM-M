...
def test_counter_increment():
    ...
    try:
        ...
        assert run_number2 == run_number1 + \
            1, f"Counter not incrementing: {run_number1} -> {run_number2}"
        assert run_number3 == run_number2 + \
            1, f"Counter not incrementing across configs: {run_number2} -> {run_number3}"
...
def test_counter_persistence():
    ...
    try:
        ...
        assert run_number2 == run_number1 + \
            1, f"Counter not persisting: {run_number1} -> {run_number2}"
